...
from webserver import CustomHTTPServer, CustomHTTPRequestHandler
import pop3_api
import sys
import html
...
class Webmailer(CustomHTTPRequestHandler):
    ...
    def login(self, args):
        ...
        if not args:
            ...
            try:
                ...
                self.redirect("/login?auth_failed=true")
    ...
    def detail(self, args):
        ...
        context = {"mail_id": mail_id, "subject": mail.get("Subject"), "from": mail.get("From"), "payload": html.escape(mail.get_payload()).replace("\n", "<br>")}
