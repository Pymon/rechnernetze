...
class CustomHTTPRequestHandler(BaseHTTPRequestHandler):
    """Custom Request handler providing:
    - basic routing
    ...
    def render(self, template, context={}, cookies={}):
        ...
        self.wfile.write(
            self._render_template(template, context).encode(
    ...
    def _handle_404(self):
        ...
        self.wfile.write(b"<h1>404 Not Found</h1><a href='/'>Back to starting page</a>")
    ...
    def _render_template(self, template_file_name: str, context: dict):
        with open(template_file_name) as template_file:
            ...
            if "infobox-area" not in context:
                context["infobox-area"] = ""
            else:
                context["infobox-area"] = "".join(
                    [infobox for infobox in context["infobox-area"]]
                )
